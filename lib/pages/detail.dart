...
import 'package:trily/bloc/state_bloc.dart';
import 'package:trily/bloc/state_provider.dart';
import 'package:carousel_slider/carousel_slider.dart';
import 'package:trily/model/car2.dart';
        ...
        builder: (context, snapshot) {
          ...
          return ScaleTransition(
            ...
            child: FadeTransition(
              opacity: Tween(begin: 0.0, end: 1.0).animate(fadeController),
              child: CarDetails(),
            ),
          );
        });
